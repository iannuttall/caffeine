...
No source code was copied from the cloned projects. The upstream Caffeine menu-bar artwork is reused under its MIT license, with the original copyright notice kept in the repository.
